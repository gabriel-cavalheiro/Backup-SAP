...
* /N/SAST/LOGON - solicitar usuario SAST
* /n/iwfnd/maint_service - verificar funcionamento de API
* segw -> vc visualiza a definição do serviço  "API"
*SO10 IMPRESSORA
*ZPP035 IMPRESSORA
*RS_HDSYS_CALL_TC_VARIANT authority chek
*reset de senha SAP* senha pass
*/n/pgtpa/op_ger op SOFICOM
*para voltar uma instrução posicionar na linha e precionar shift f12
*SU01D - visualizar dados de usuario SAP
...
* marretar tabela se16n Na tela que se abre (ABAP debugger) insira as variáveis GD-EDIT e GD-SAPEDIT e atribua a elas o valor “X”.
...
" (para mais transações de IDOCs, clique AQUI )
