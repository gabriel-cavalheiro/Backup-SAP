REPORT ZABRE MESSAGE-ID 0K.
TABLES: TRDIR.
PARAMETERS PROGRAM LIKE RS38M-PROGRAMM.
DATA: I_CONTENT(180) OCCURS 0 WITH HEADER LINE, MSG(400), ANSWER.
...
CONCATENATE 'Erro de syntax na linha' U-TXTINDEX INTO U-TXTINDEX
SEPARATED BY SPACE.
